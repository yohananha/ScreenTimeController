...
| Mobile (parent phone, legacy) | [ScreenTime-Mobile-debug.apk](https://github.com/yohananha/ScreenTimeController/releases/download/v0.1.18-beta/mobile-debug.apk) |
| TV | [ScreenTime-TV-debug.apk](https://github.com/yohananha/ScreenTimeController/releases/download/v0.1.18-beta/tv-debug.apk) |
